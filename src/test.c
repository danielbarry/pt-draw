...
int main(){
  ...
  UINT8 diagLineA[3] = {LINE, 0x00, 0xFF};
  UINT8 diagLineB[3] = {LINE, 0xF0, 0x0F};
  UINT8 cross[6] = {LINE, 0x22, 0xDD, LINE, 0xD2, 0x2D};
  UINT8 square[6] = {LINE | (4 - 1), 0x22, 0xD2, 0xDD, 0x2D, 0x22};
  UINT8 squareCross[12] = {LINE, 0x22, 0xDD, LINE, 0xD2, 0x2D, LINE | (4 - 1), 0x22, 0xD2, 0xDD, 0x2D, 0x22};
  UINT8 curve[4] = {CURV, 0x00, 0xF0, 0xFF};
  UINT8 letterS[8] = {CURV | (3 - 1), 0xD2, 0x00, 0x26, 0x77, 0xD8, 0xFF, 0x2D};
  UINT8 dollar[14] = {CURV | (3 - 1), 0xD2, 0x00, 0x26, 0x77, 0xD8, 0xFF, 0x2D, LINE, 0x60, 0x6F, LINE, 0x90, 0x9F};
